...
## File Name: mac_serial_2.sdc
## Function:  SDC constraints for mac_serial with CONFIG_W_WIDTH=2
## Notes:     STA considering symmetric inputs with data-gating of input a and w_serial
## Version:   2.0
##-----------------------------------------------------

##     !!!!!!!!!!!!!!!!!!!!!!!!!!
##     !  NOT for 4-bit serial  !
##     !!!!!!!!!!!!!!!!!!!!!!!!!!
...
set_case_analysis 0 config_w[1]
set_case_analysis 0 mac/config_w[1]
...
set_case_analysis 1 config_w[1]
set_case_analysis 1 mac/config_w[1]
...
# symmetrically data-gated a input (!!! a input only for 1-bit and 2-bit serial !!!)
