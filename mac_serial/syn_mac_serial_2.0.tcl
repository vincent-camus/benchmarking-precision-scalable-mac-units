...
## File Name: syn_mac_serial_2.0.tcl
## Function:  synthesis script for mac_serial
## Version:   2.0
## Notes:     for external DVFS framework version 2.1
##-----------------------------------------------------
...
if {[info exists AUTO]} {
    ...
    set RTL_FILE     ../auto/mac_serial/mac_serial_1.9.sv
    ...
    # Paths
    set BATCH_PATH   ../auto/mac_serial/batch_1.9
    set SDC_PATH     ../auto/mac_serial/constraints_2.0
