...
## File Name: syn_mac_bfusion1d_2.0.tcl
## Function:  synthesis script for mac_bfusion1d
## Version:   2.0
...
if {[info exists AUTO]} {
    ...
    # Design
    set DESIGN       mac_bfusion1d
    set RTL_FILE     nc
    
    # Entity
    set ENTITY       mac_bfusion1d_1
    ...
    # Paths
    set BATCH_PATH   ../auto/mac_bfusion1d/batch_1.0
    set SDC_PATH     ../auto/mac_bfusion1d/constraints_2.0
    set REPORT_PATH  ./test_bfusion1d
    set EXPORT_PATH  ./test_bfusion1d
...
# Ungroup all but mac
ungroup /designs/top_mac_bfusion1d/mac/* -flatten
...
regexp -linestop {mac_bfusion1d_(\d+)$} $ENTITY MATCHED SCALABLE_LEVELS
...
if {$SCALABLE_LEVELS == 2} {
    ...
    echo "Mode 4b_2b: 4" >> $REPORT_PATH/$FULLNAME.rpt
    echo "Mode 8b_2b: 4" >> $REPORT_PATH/$FULLNAME.rpt
    echo "Mode 4b_4b: 2" >> $REPORT_PATH/$FULLNAME.rpt
    echo "Mode 8b_4b: 2" >> $REPORT_PATH/$FULLNAME.rpt
    echo "Mode 8b_8b: 1" >> $REPORT_PATH/$FULLNAME.rpt
} elseif {$SCALABLE_LEVELS == 1} {
    echo "Mode 2b_2b: 2" >> $REPORT_PATH/$FULLNAME.rpt
    echo "Mode 4b_2b: 2" >> $REPORT_PATH/$FULLNAME.rpt
