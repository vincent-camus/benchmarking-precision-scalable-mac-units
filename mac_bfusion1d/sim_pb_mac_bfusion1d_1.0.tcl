...
## File Name: sim_pb_mac_bfusion1d_2.0.tcl
## Function:  power bench simulation script for mac_bfusion1d
## Version:   2.0
...
if {[info exists AUTO]} {
    ...
    # Files
    set VERILOG_FILE    ../syn/test_bfusion1d/mac_bfusion1d_1_clk:1.1-0.9-0.7-sdc2.v
    set SDF_FILE        ../syn/test_bfusion1d/mac_bfusion1d_1_clk:1.1-0.9-0.7-sdc2.sdc
    set PB_FILE         ../auto/mac_bfusion1d/pb_1.0/pb_mac_bfusion1d_1.sv
...
regexp -linestop {mac_bfusion1d_(\d+)_} $VERILOG_FILE MATCHED SCALABLE_LEVELS
...
if {[info exists AUTO]} {
    ...
    vsim pb_mac_bfusion1d -t 100fs \
        ...
        -sdfmax top_mac_bfusion1d=$SDF_FILE
    ...
    vsim pb_mac_bfusion1d -t 100fs \
        ...
        add wave -radix binary -r     sim:/pb_mac_bfusion1d/top_mac_bfusion1d/*

        add wave -height 40 -divider  "mac" 
        add wave -radix binary -r     sim:/pb_mac_bfusion1d/top_mac_bfusion1d/mac/*
